...
Modelo & $n_1$ & $n_2$ & $p$ & Optimizador & Batch-size & learning-rate & Comentario\\ % Agregar para seguir en la columna debajo. El & se usa para separar las entradas de las columnas.
\hline
